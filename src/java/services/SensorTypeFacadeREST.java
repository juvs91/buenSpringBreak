...
public class SensorTypeFacadeREST extends AbstractFacade<SensorType> {
    ...
    public void create(SensorType entity) {
        super.create(entity);
    }
    ...
    @Override
    @Consumes({"application/xml", "application/json"})
    public void edit(SensorType entity) {
        super.edit(entity);
    }
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<SensorType> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
